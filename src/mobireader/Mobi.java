...
public class Mobi {
    ...
    public Header parseHeader() throws DecodingException, IOException {
        Header parsedHeader = createHeaderBasedOn(file);
        return parsedHeader;
    }

    public Header createHeaderBasedOn(File file) throws  DecodingException, IOException {
    ...
    public ArrayList<RecordInfo> parseRecordInfoList(File file, int offset) throws DecodingException, IOException {
    ...
    public String readRecord(int index, boolean disable_compression) throws IOException {
        ...
        if (palmdocHeader.Compression == 1 || disable_compression) {
            ...
            return "Unknown compression type, raw: " + new String(rawRecord);
        }
    }
